...
Note8posWords.match = match(posWords,noteTweetsClean )
#Verifica que elementos no son null
IphoneposWords.match = !is.na(IphoneposWords.match)
Note8posWords.match = !is.na(Note8posWords.match )

#Mapeo de palabras Negativas
IphonenegWords.match = match(negWords,iphoneTweetsClean)
Note8negWords.match = match(negWords, noteTweetsClean)
#Verifica que elementos no son null
IphonenegWords.match = !is.na(IphonenegWords.match)
Note8negWords.match = !is.na(Note8negWords.match)
